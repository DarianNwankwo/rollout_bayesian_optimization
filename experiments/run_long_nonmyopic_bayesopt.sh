...
nonmyopic_configurations=(
    ...
    "--output-dir longrun-bayesopt --optimize --starts 8 --budget 60 --trials 50 --function-name holdertable --horizon 1 --batch-size 8"
    "--output-dir longrun-bayesopt --optimize --starts 8 --budget 60 --trials 50 --function-name eggholder --horizon 1 --batch-size 8"
    "--output-dir longrun-bayesopt --optimize --starts 8 --budget 60 --trials 50 --function-name bukinn6 --horizon 1 --batch-size 8"
    "--output-dir longrun-bayesopt --optimize --starts 8 --budget 60 --trials 50 --function-name rosenbrock --horizon 1 --batch-size 8"
)
