...
configurations=(
    ...
    "--output-dir data-without-optimal-surrogate --function-name styblinskitang1d"
    "--output-dir data-without-optimal-surrogate --function-name styblinskitang2d"
    "--output-dir data-without-optimal-surrogate --function-name styblinskitang3d"
    "--output-dir data-without-optimal-surrogate --function-name styblinskitang4d"
    "--output-dir data-without-optimal-surrogate --function-name styblinskitang10d"
